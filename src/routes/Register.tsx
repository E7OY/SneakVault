            ...
            <div className="register my-5 p-5">
                <div className="row mx-auto">
                    <div className="mx-auto col-12 col-md-6 border border-1 border-black py-5 d-flex text-center flex-column justify-content-center">
                        ...
                        <h6 className='my-3 fw-light'>Registrate y consigue un 10% de descuento</h6>
                        {user ? (
                        ...
                        <Form method='post' onSubmit={register}>
                            <div className='form-field'>
                                ...
                                <div className='form-field w-75 d-flex justify-content-center flex-row gap-4 mx-auto'>
                                    <div>
